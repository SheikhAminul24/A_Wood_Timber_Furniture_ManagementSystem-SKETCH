 ...
 * @author AMINUL
 */
public class wood_reservation_delete extends javax.swing.JFrame {

    /**
     * Creates new form wood_reservation_delete
     */
    public wood_reservation_delete() {
        initComponents();
    }
    ...
    private void deleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBtnActionPerformed
        try {
            ...
            statement.executeUpdate("delete from WoodReservation where wreserve_No = '"+Integer.parseInt(jTextField1.getText())+"'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(wood_reservation_delete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
